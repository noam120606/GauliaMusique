...
module.exports =  {
    ...
    run: async (interaction) => {
        ...
        const guildMusicStats = client.player.queues.get(interaction.guild)?.stats?.generate();

        const shardPlayerCount = await client.player.queues.cache.array().length;
        const totalPlayerCount = (await client.shard.broadcastEval(c => c.player.queues.cache.array().length)).reduce((prev, val) => prev + val, 0);
        ...
        .addFields({
            ...
            value: [
                ...
                `<:g_automod:1171091264792449074> **Players** : \`${totalPlayerCount}\``,
        ...
        .addFields({
            ...
            value: [
                ...
                `<:g_automod:1171091264792449074> **Players** : \`${shardPlayerCount}\``,
            ].join('\n'), 
            inline: true 
        })
